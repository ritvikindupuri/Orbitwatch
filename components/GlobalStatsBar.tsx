        ...
        <div className="px-3 py-4 bg-black border-b border-white/10 z-10">
            <div className="flex items-center space-x-3">
                ...
                <StatCard 
                    title="RELAY LINK" 
                    value={relayStatus} 
                    valueColor={relayStatus === 'LINKED' ? 'text-green-500' : 'text-gray-600'} 
                    tooltipTitle="Intelligence Relay Protocol"
                    tooltipContent="Status of the connection to the Multi-Operator Intelligence Hub via server.js relay."
                    tooltipFooter={relayStatus === 'LINKED' ? "Active Pipeline to Elastic Cloud" : "Middleware Inactive"}
                />
                <StatCard 
                    title="ANOMALY FEED" 
                    value={activeAlerts} 
